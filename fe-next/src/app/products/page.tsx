    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      {isLoading ? (
        <div className="flex flex-col justify-center items-center py-20">
          ...
          <p className="mt-6 text-gray-600 dark:text-gray-400 font-medium">Carregando produtos...</p>
        </div>
      ) : error ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
            Comece criando seu primeiro produto para gerenciar seu catálogo de forma eficiente.
          </p>
          <Button
            onClick={() => {
              setEditingProduct(null);
          ...
          {products.map((product) => (
            ...
            >
              ...
              <CardContent className="space-y-4">
                <div className="py-3 px-4 rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950/50 dark:to-blue-900/30 border border-blue-200 dark:border-blue-800/50">
                ...
                <div className="space-y-2 text-sm">
                  {product.description && (
                    <div className="py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                      <p className="text-gray-700 dark:text-gray-300">
                        <span className="font-medium text-gray-500 dark:text-gray-400">📝 Descrição:</span>{" "}
                        {product.description}
                      </p>
                    </div>
                  )}
                  {product.sku && (
                    <div className="flex items-center gap-2 py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                      ...
                      <span className="text-gray-700 dark:text-gray-300 font-medium">SKU: {product.sku}</span>
                    </div>
                  )}
                  {product.stock_quantity !== undefined && (
                    <div className="flex items-center gap-2 py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                      <span className="text-gray-500 dark:text-gray-400">📦</span>
                      <span className="text-gray-700 dark:text-gray-300 font-medium">Estoque: {product.stock_quantity}</span>
                    </div>
                  )}
                </div>
